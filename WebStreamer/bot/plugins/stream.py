...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        msg_text ="""<i><b><u>لـیـنـک فـایـل شـمـا سـاخـتـه شـد ✅ !</u><b></i>\n\n<b>📂 نام فایل :</b> <i>{}</i>\n\n<b>📦 حجم فایل :</b> <i>{}</i>\n\n<b>📥 لینک دانلود :</b> <i>{}</i>\n\n<b> 🖥 پخش آنلاین :</b> <i>{}</i>\n\n<b>🚸 توجه : لینک شما پس از 24 ساعت منقضی خواهد شد.</b>"""
        ...
        await m.reply_text(
            ...
            quote=True,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("پخش آنلاین 🖥", url=stream_link), #Stream Link
                                                InlineKeyboardButton('دانلود 📥', url=online_link)]]) #Download Link
        )
...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("🖥پخش آنلاین ", url=stream_link),
                     InlineKeyboardButton('دانلود📥', url=online_link)] 
                ]
            )
        )
